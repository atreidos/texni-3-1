...
serve(async (req) =>
  runWithHttpMutationLog(req, "create-payment", async () => {
    ...
    try {
      ...
      if (error) {
        logError(error, { function: "create-payment", phase: "payments_insert" });
        return new Response(
      ...
      logBusiness(
        ...
        { userId: user_id, plan, amount, status },
      ...
      logError(e, { function: "create-payment" });
